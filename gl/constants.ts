...
export type TextureFormat =
    GL.ALPHA | GL.DEPTH_COMPONENT | GL.DEPTH_STENCIL | GL.LUMINANCE |
    GL.LUMINANCE_ALPHA | GL.RED | GL.RED_INTEGER | GL.RG | GL.RGB |
    GL.RGBA | GL.RGBA_INTEGER | GL.RGB_INTEGER | GL.RG_INTEGER;

export type TextureType =
    GL.BYTE | GL.FLOAT | GL.FLOAT_32_UNSIGNED_INT_24_8_REV | GL.HALF_FLOAT | GL.INT |
    GL.SHORT | GL.UNSIGNED_BYTE | GL.UNSIGNED_INT | GL.UNSIGNED_INT_10F_11F_11F_REV |
    GL.UNSIGNED_INT_24_8 | GL.UNSIGNED_INT_2_10_10_10_REV | GL.UNSIGNED_INT_5_9_9_9_REV |
    GL.UNSIGNED_SHORT | GL.UNSIGNED_SHORT_4_4_4_4 | GL.UNSIGNED_SHORT_5_5_5_1 |
    GL.UNSIGNED_SHORT_5_6_5;
